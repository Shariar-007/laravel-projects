          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                <img src="{{asset($post->user->image)}}" alt="Image Placeholder" class="img-fluid mb-5" style="height: 200px; width: auto;">
                <div class="bio-body">
              ...
              <div class="post-entry-sidebar">
                <ul>
                  ...
                  @foreach($popularPosts as $popularPost)
                    <li>
                      <a href="">
                        <img src="{{asset($popularPost->image)}}" alt="Image placeholder" class="mr-4">
                        <div class="text">
                          <h4>{{$popularPost->title}}</h4>
                          <div class="post-meta">
                            <span class="mr-2">{{$popularPost->created_at->format("M d, Y")}} </span>
                          </div>
                        </div>
                      </a>
                    </li>
